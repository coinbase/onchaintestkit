...
export async function importWallet(
  ...
  try {
    ...
    await page.waitForSelector('button:has-text("I already have a wallet")', { state: 'visible' })
    await page.click('button:has-text("I already have a wallet")')
    await page.waitForLoadState("networkidle")
        
    // Step 2: Wait for and click "Import Recovery Phrase" button
    await page.waitForSelector('button:has-text("Import Recovery Phrase")', { state: 'visible' })
