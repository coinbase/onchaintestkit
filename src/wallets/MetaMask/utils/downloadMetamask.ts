 ...
 */
async function getRemoteFile({ url, outputPath, useCache = true }: FileRequest): Promise<boolean> {
 ...
 */
async function unpackZipArchive({ zipFile, useCache = true }: UnpackRequest): Promise<string> {
