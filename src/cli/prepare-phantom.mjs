...
async function setupPhantomExtraction() {
  ...
  try {
    ...
    console.log(`Phantom Wallet extension successfully prepared at: ${extractionPath}`);
...
async function main() {
  try {
    ...
    console.log(`Phantom Wallet extension prepared successfully at: ${extensionPath}`);
